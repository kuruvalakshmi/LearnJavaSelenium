...
public class ProjectSpecificMethod extends ProjectSpecificBaseClass {
	            ...
	            public String[][] sendData() throws IOException {
	            	String[][] data = ProExcel.readData();
	            	return data;
	            }
	            
@Test(dataProvider="fetchData")
	 public void runProjectSpecificMethod(String name, String company) throws InterruptedException {
	    ...
	    Thread.sleep(1000);
	     ...
	     //enter name
	     driver.findElement(By.xpath("//div[@class='slds-form-element__control slds-grow']//input[@class='slds-input']")).sendKeys(name);
	     //company name
